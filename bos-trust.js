/* bos-trust.js — Bloc de réassurance universel BOS (v1, 13/07/2026 — variante FootPerf)
   Injecte une rangée de garanties sous le bouton d'achat.
   ...
   ⚠️ FootPerf annonce 14 jours de rétractation (CGV art. 6 + section Garanties) — pas 30. */
(function () {
  ...
  var ITEMS = [
    ...
    { ic: '💬', t: 'Support réactif', s: 'contact@footperf.fr' }
  ];
  ...
  function build() {
    ...
    grid += '<div class="bos-tr-pay"><span class="bos-tr-badge">🔒 Commande protégée</span>'
      + '<span>Livraison estimée 12 à 20 jours ouvrés · <b>Paiement 100% sécurisé</b></span></div>';
    wrap.innerHTML = grid;
    return wrap;
  }
