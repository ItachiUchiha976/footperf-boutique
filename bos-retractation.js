...
(function () {
  ...
  // FootPerf est un catalogue mono-page : boutons reels = .add-to-cart / .fiche-add /
  // .buy-now-btn (index.html) et .btn-buy (coupe-du-monde-2026).
  var isPurchasePage = !!document.querySelector('[data-add-cart]') ||
      !!document.querySelector('.add-to-cart, .fiche-add, .buy-now-btn, .btn-buy') ||
